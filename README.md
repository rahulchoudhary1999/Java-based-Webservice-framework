...
```
Example url to access add service http://localhost:8080/"user's-application-context-name"/"service"/employee/add?username=Rahul+Choudhary&gender=male&indian=true To access Boolean data client user must send data as True or TRUE or true and same goes for it counterpart.
